...
export class OpenAIEmbeddings {
  ...
  constructor(config: Partial<EmbeddingConfig> = {}) {
    this.config = {
      ...
      model: 'text-embedding-3-large', // Use context7: Latest high-quality model
      batchSize: 50, // Use context7: Optimal batch size for API limits
      retryAttempts: 3,
      retryDelay: 1000,
      ...config
    };
...
/**
 * Default OpenAI embeddings instance
 */
export const defaultEmbeddings = createOpenAIEmbeddings();