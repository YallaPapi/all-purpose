# Zero-Assumption Documentation (ZAD) Framework
...
**Remember**: If someone needs to ask "but why does this exist?" after reading your documentation, you haven't applied ZAD properly.