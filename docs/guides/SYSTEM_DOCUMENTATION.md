...
- Template system for different industries (`/packages/shared-lib/prompt-template-manager.ts`)
...
**Prompt Template Manager** (`/packages/shared-lib/prompt-template-manager.ts`)
