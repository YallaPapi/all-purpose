...
export class TemplateLoader {
  ...
  private async loadBuiltInTemplates(): Promise<void> {
    if (!this.config.templatesPath) return;
  ...
  private async loadCustomTemplates(): Promise<void> {
    if (!this.config.customTemplatesPath) return;
   ...
   */
  static async create(config: TemplateLoaderConfig = {}): Promise<TemplateEngine> {
  ...
  private registerGenericReplacementTemplate(): void {
...
`;
  ...
  private registerConfigHelperTemplate(): void {
