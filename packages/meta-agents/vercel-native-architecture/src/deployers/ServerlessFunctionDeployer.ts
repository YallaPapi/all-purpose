...
export class ServerlessFunctionDeployer extends EventEmitter {
   ...
   */
  async buildFunctions(design: any, functionSpecs?: any): Promise<{
   ...
   */
  private async buildApiFunctions(design: any, apiSpecs: any[]): Promise<ApiFunction[]> {
   ...
   */
  private async buildEdgeFunctions(design: any, edgeSpecs: any[]): Promise<EdgeFunction[]> {
   ...
   */
  private async buildCronFunctions(design: any, cronSpecs: any[]): Promise<CronFunction[]> {
    console.log(chalk.blue('⏰ Building Cron functions...'));

    const cronFunctions: CronFunction[] = [];
   ...
   */
  private async buildMiddlewareFunctions(design: any, middlewareSpecs: any[]): Promise<MiddlewareFunction[]> {
    ...
    for (const spec of middlewareSpecs) {
      const middlewareFunction: MiddlewareFunction = {
  ...
  private async generateFunctionCode(apiFunction: ApiFunction, design: any): Promise<void> {
  ...
  private async generateEdgeFunctionCode(edgeFunction: EdgeFunction, design: any): Promise<void> {
  ...
  private async generateCronFunctionCode(cronFunction: CronFunction, design: any): Promise<void> {
  ...
  private async generateMiddlewareFunctionCode(middlewareFunction: MiddlewareFunction, design: any): Promise<void> {
  ...
  private generateApiFunctionTemplate(apiFunction: ApiFunction, design: any): string {
    return `/**
...
export const config = {
  ...
  private generateEdgeFunctionTemplate(edgeFunction: EdgeFunction, design: any): string {
    return `/**
...
export const config = {
  ...
  private generateCronFunctionTemplate(cronFunction: CronFunction, design: any): string {
    return `/**
...
export const config = {
  ...
  private generateMiddlewareTemplate(middlewareFunction: MiddlewareFunction, design: any): string {
    return `/**
...
export const config = {
  ...
  private async generateDefaultApiFunctions(design: any): Promise<any[]> {
  ...
  private async buildKVConnections(kvStores: any[]): Promise<any[]> {
  ...
  private async buildBlobConnections(blobStores: any[]): Promise<any[]> {
  ...
  private async buildQueueConnections(queueConnections: any[]): Promise<any[]> {
  ...
  private async buildExternalApiConnections(externalApis: any[]): Promise<any[]> {
  ...
  private async buildAlertRules(alerts: any[]): Promise<any[]> {
