...
echo "Building Real Factory Core with actual meta-agents..."

# Create a temporary build directory
BUILD_DIR="/tmp/factory-build-$$"
mkdir -p "$BUILD_DIR"
...
docker build -t real-factory-core:latest "$BUILD_DIR"

# Clean up
rm -rf "$BUILD_DIR"

echo "Build complete! Run with: docker run -p 3001:3000 --network all-purpose_meta-agent-network real-factory-core:latest"