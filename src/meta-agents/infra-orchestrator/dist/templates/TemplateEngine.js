...
export class TemplateEngine {
     ...
     */
    async generateCode(templateId, context = {}) {
     ...
     */
    async generateReplacementForPattern(detectionResult, additionalContext = {}) {
     ...
     */
    async generateFromSource(templateSource, context = {}) {
        const startTime = Date.now();
        try {
     ...
     */
    async saveGeneratedCode(result, filePath, options = {}) {
        if (!result.success) {
     ...
     */
    async previewTemplate(templateId, context = {}) {
        const fullContext = this.mergeContext(context);
    ...
    getTemplateIdForPattern(ruleId) {
    ...
    enrichContextForPattern(context, detectionResult) {
