...
export class IntegrationCoordinator extends EventEmitter {
     ...
     */
    async sendToIntegration(agentId, data) {
        const integration = this.integrations.get(agentId);
        if (!integration) {
     ...
     */
    async transformDataForIntegration(data, integration) {
    ...
    async applyDataTransformation(data, transformation, integration) {
    ...
    async performIntegrationCall(integration, data) {
    ...
    async callMetaAgent(integration, data) {
    ...
    async callExternalSystem(integration, data) {
    ...
    async processIntegrationResponse(response, integration) {
    ...
    transformDetectionToGeneration(data) {
        return {
            ...data,
    ...
    transformAnalysisToTemplates(data) {
        return {
            ...data,
    ...
    transformHealthMonitoring(data) {
        return {
            ...data,
    ...
    transformPatternToTemplate(data) {
        return {
            ...data,
    ...
    transformKnowledgeToContext(data) {
        return {
            ...data,
    ...
    transformSemanticEnrichment(data) {
        return {
            ...data,
...
//# sourceMappingURL=IntegrationCoordinator.js.map