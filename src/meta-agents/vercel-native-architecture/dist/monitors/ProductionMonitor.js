...
export class ProductionMonitor extends EventEmitter {
    ...
    async generateAnalyticsConfiguration(requirements) {
        return {
    ...
    async generateSpeedInsightsConfiguration(requirements) {
        return {
    ...
    async generateLogConfiguration(requirements) {
        return {
    ...
    async generateAlertConfiguration(requirements) {
        return [
            {
    ...
    async generatePerformanceMetrics(design) {
        return [
            {
                name: 'Response Time',
                type: 'histogram',
...
//# sourceMappingURL=ProductionMonitor.js.map