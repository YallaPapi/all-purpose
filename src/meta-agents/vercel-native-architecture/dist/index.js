...
// Helper Functions
export function createDefaultVercelArchitecture(name, framework) {
    return {
        name,
...
export function isRuntimeSupported(runtime) {
    return SUPPORTED_RUNTIMES.includes(runtime);
}
export function getOptimalRegions(globalDistribution = true) {
