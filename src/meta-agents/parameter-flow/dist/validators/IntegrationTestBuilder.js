...
export class IntegrationTestBuilder extends EventEmitter {
     ...
     */
    async createTestSuitesForIntegration(topology, pipelines) {
    ...
    async executeTests(request) {
        ...
        if (request.testScope && request.testScope !== 'all') {
            testSuitesToRun = testSuitesToRun.filter(suite => suite.structure.testGroups.some(group => group.groupType === request.testScope));
        }
        let totalTests = 0;
        let passedTests = 0;
        let failedTests = 0;
     ...
     */
    async createComponentIntegrationTestSuite(topology) {
    ...
    async createPipelineTestSuite(pipelines) {
    ...
    async createEndToEndTestSuite(topology, pipelines) {
    ...
    async createPerformanceTestSuite(topology) {
    ...
    async createSecurityTestSuite(topology) {
    ...
    async createComponentTestGroup(component) {
    ...
    async createComponentTestCase(component) {
    ...
    async createPipelineTestGroup(pipeline) {
    ...
    async createPipelineTestCase(pipeline) {
    ...
    async createEndToEndTestGroup(topology, pipelines) {
    ...
    async createEndToEndTestCase(topology, pipelines) {
    ...
    async createPerformanceTestGroup(topology) {
    ...
    async createPerformanceTestCase(topology) {
    ...
    async createSecurityTestGroup(topology) {
    ...
    async createSecurityTestCase(topology) {
     ...
     */
    async executeSingleTestSuite(suite, configuration) {
    ...
    // Analysis methods
    calculateComponentCoverage(results) {
        return 85; // Simulated coverage
    }
    calculateIntegrationCoverage(results) {
        return 78; // Simulated coverage
    }
    calculateDataFlowCoverage(results) {
        return 92; // Simulated coverage
    }
    calculateErrorScenarioCoverage(results) {
    ...
    calculateTestEffectiveness(results) {
        return 88; // Simulated effectiveness
    }
    calculateDefectDetectionRate(results) {
        return 75; // Simulated detection rate
    }
    calculateFalsePositiveRate(results) {
...
//# sourceMappingURL=IntegrationTestBuilder.js.map