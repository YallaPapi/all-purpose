...
import { createOpenAIEmbeddings, OpenAIEmbeddings, EmbeddingResult } from '../embeddings/openaiEmbeddings';
...
export class RAGPipeline extends EventEmitter {
  ...
  private async generateEmbeddings(
    ...
    const results: Array<{ chunk: DocumentChunk; embedding: EmbeddingResult }> = [];
  ...
  private async storeEmbeddings(
    embeddingResults: Array<{ chunk: DocumentChunk; embedding: EmbeddingResult }>,
    progress: ProcessingProgress
  ): Promise<void> {
 ...
 */
export const defaultRAGPipeline = createRAGPipeline();